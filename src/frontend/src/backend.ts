...
export class Backend implements backendInterface {
    ...
    async addToCart(arg0: string, arg1: CartItem): Promise<void> {
    ...
    async getAccessoryPrices(): Promise<AccessoryPrices> {
        if (this.processError) {
            try {
                const result = await this.actor.getAccessoryPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAccessoryPrices(arg0: bigint, arg1: bigint, arg2: bigint, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAccessoryPrices(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
